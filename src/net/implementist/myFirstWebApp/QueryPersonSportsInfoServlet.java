...
@WebServlet(name = "QueryPersonSportsInfoServlet")
public class QueryPersonSportsInfoServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            ArrayList<PersonSportsInfo> mySteps = PersonSportsInfoDAO.queryPersonSportsInfoById(myId);
            if (mySteps.size()!=0) {
