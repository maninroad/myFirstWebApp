...
@WebServlet(name = "UpdatePersonSportsInfoServlet")
public class UpdatePersonSportsInfoServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            boolean personalInfo = PersonSportsInfoDAO.UpdatePersonSportsInfo( myId,date,calories,type, durations);
            if (personalInfo) {
